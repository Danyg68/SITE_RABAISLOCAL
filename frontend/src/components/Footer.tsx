        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/categories/resto" className="hover:text-gray-200 transition">
                  Resto
                </Link>
              </li>
              <li>
          ...
          {/* Additional Links */}
          <div>
            <h3 className="font-bold text-lg mb-4">Loisirs</h3>
            <ul className="space-y-2">
              <li>
                <Link href="/livre-de-loisirs" className="hover:text-gray-200 transition">
                  Livre de loisirs
                </Link>
              </li>
              <li>
                <Link href="/bons-plans" className="hover:text-gray-200 transition">
                  Bons plans
                </Link>
              </li>
              <li>
                <Link href="/bassins" className="hover:text-gray-200 transition">
                  Bassins
                </Link>
              </li>
            </ul>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="bg-white text-blue-700 w-8 h-8 rounded-full flex items-center justify-center hover:bg-gray-100 transition"
                aria-label="Facebook"
              >
